...
//waarde null als dit niet gecheckt word
        echo "<input type='hidden' name='artidvak' value='".$prodID."'>";
    ...
    public function searchArtikel()
    {
        ...
        foreach($sql as $artikel)
        {
            ...
            $this->artikel=$artikel["artOmschrijving"];
            $this->artikel=$artikel["artVoorraad"];
            $this->artikel=$artikel["artMinVoorraad"];
            $this->artikel=$artikel["artMaxVoorraad"];
        }
        echo "<a href='../artikelen/artikelmenu.php'> terug naar het menu </a>";
    }
